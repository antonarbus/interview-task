...
const colsOutput = [
  {name: 'OrderDate', label: 'OrderDate', field: 'OrderDate', align: 'center', sortable: true},
  {name: 'Region', label: 'Region', field: 'Region', align: 'center', sortable: true},
  {name: 'Rep', label: 'Rep', field: 'Rep', align: 'center', sortable: true},
  {name: 'Item', label: 'Item', field: 'Item', align: 'center', sortable: true},
  {name: 'Units', label: 'Units', field: 'Units', align: 'center', sortable: true},
  {name: 'Unit Cost', label: 'Unit Cost', field: 'Unit Cost', align: 'center', sortable: true}
]
...
const rowsOutputTable1 = [ {Item: "Pencil", OrderDate: "2021.01.01", Region: "East", Rep: "Johns", 'Unit Cost': 1.99, Units: 95} ]
...
const rowsOutputTable2 = [ 
  {'Last OrderDate': '2021.01.01', Region: 'East', 'Total Units': 95, 'Total Cost': 189.05},
  {'Last OrderDate': '2020.12.31', Region: 'West', 'Total Units': 500, 'Total Cost': 570},
  {'Last OrderDate': '2018.10.10', Region: 'North', 'Total Units': 185, 'Total Cost': 12170},
]
test('return certain array for rows', () => { 
